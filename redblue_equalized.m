function map = redblue_equalized(N_raw, min_lux, white_prct)
...
if min_lux < .25
    warning('Values must be bigger than .25 to make sure lux is equal');
end
...
map = equalize_divcmap(map, min_lux, Nr, false);
